...
using static ZeroStack.IdentityServer.API.Infrastructure.Authentication.QQ.QQAuthenticationConstants;

namespace ZeroStack.IdentityServer.API.Infrastructure.Authentication.QQ;
