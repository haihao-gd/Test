...
using static ZeroStack.IdentityServer.API.Infrastructure.Authentication.Weixin.WeixinAuthenticationConstants;

namespace ZeroStack.IdentityServer.API.Infrastructure.Authentication.Weixin;
