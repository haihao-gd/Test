...
using static ZeroStack.IdentityServer.API.Infrastructure.Authentication.Weibo.WeiboAuthenticationConstants;

namespace ZeroStack.IdentityServer.API.Infrastructure.Authentication.Weibo;
